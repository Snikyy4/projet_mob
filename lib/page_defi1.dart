              ...
              actions: [
                TextButton(
                  onPressed: () {
                    ...
                    navigateTo(context, MyHomePage(pseudo: nom_user, nbVictoires: nb_victoires, tempsTaupe: temps_taupe, scoreAlien: scoreAlienRun, tempsBoussole: temps_boussole,tempsLab: temps_lab,));
                  },
                  child: const Text('OK'),
                ),
              ],
